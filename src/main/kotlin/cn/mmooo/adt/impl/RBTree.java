...
public class RBTree<T extends Comparable<T>> {
        ...
        while (dataRoot != null) {
            ...
            if (cmp < 0) {
                ...
                if (dataRoot.getRight() != null) {
                    ...
                    min.setColor(dataRoot.getColor());
    ...
    private void fixRemove(RBTreeNode<T> node, boolean isParent) {
        ...
        boolean isRed = !isParent && node.getColor();
        ...
        while (!isRed && !isRoot(cur)) {
            ...
            if (sibling.getColor() && !isLeft) {//case 1
                //cur in right
                parent.makeRed();
                sibling.makeBlack();
                rotateRight(parent);
            } else if (sibling.getColor() && isLeft) {
                //cur in left
                parent.makeRed();
                sibling.makeBlack();
                rotateLeft(parent);
    ...
    private void fixInsert(RBTreeNode<T> x) {
        ...
        while (parent != null && parent.getColor()) {
    ...
    private static class RBTreeNode<T extends Comparable<T>> {
        ...
        private boolean color;//color is red or not red
